...
public class PaymentServiceTest {
    ...
    void setUp() {
        ...
        sourceUser.setPaymentPasswordHash("password123");
        ...
        destinationUser.setPaymentPasswordHash("password123");
    ...
    void testGetPaymentsByUser_Success() {
        ...
        when(paymentRepository.findBySourceAccount_IdOrDestinationAccountId(1L, 1L))
        ...
        assertEquals(2L, responses.get(1).paymentId());

        verify(paymentRepository, times(1)).findBySourceAccount_IdOrDestinationAccountId(1L, 1L);
    }
    ...
    void testGetPaymentHistory_Success() {
        ...
        // Act
        List<PaymentHistoryResponse> response = paymentService.getPaymentHistory(1L);

        // Assert
        assertNotNull(response);
        assertEquals(2, response.size());
        assertEquals(1L, response.get(0).paymentId());
        assertEquals(PaymentStatus.CREATED, response.get(0).newStatus());
        assertEquals(PaymentStatus.VALIDATED, response.get(1).newStatus());
    ...
    void testUpdatePaymentStatus_InvalidTransition_CompletedToFailed() {
        ...
        // Act & Assert
        assertThrows(com.example.paymentprocessing.exception.InvalidPaymentStatusException.class,
    ...
    void testUpdatePaymentStatus_ValidTransition_ValidatedToSent() {
        ...
        UpdatePaymentStatusRequest request = new UpdatePaymentStatusRequest(PaymentStatus.SENT);
